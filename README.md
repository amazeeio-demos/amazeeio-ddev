...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/amazeeio-demos/amazeeio-ddev.git amazeeio-ddev && cd $_
    ```
...
4. Visit the new site @ `http://amazeeio-ddev.docker.amazee.io`
...
6. Visit the new site @ `http://amazeeio-ddev.lndo.site`
